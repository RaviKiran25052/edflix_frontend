...
const ProcessSection = () => {
	...
	const processSteps = [
		{
			number: "01",
			title: "Security Planning & Threat Modeling",
			description: "Identify risks early, choose secure architecture and cloud setup.",
			icon: Users,
		...
		},
		{
			...
			description: "OWASP guidelines, input validation, and secure APIs built in.",
			icon: Layout,
			imagePath: "./images/process2.png"
		},
		{
			number: "03",
			title: "Vulnerability Testing & Fixes",
			description: "Perform internal scans, penetration tests, and patch vulnerabilities fast.",
			icon: Code,
			imagePath: "./images/process3.png"
		},
		{
			number: "04",
			title: "Monitoring & Compliance Support",
			description: "Post-launch security monitoring and help with compliance (GDPR, HIPAA, etc.).",
			icon: Shield,
