	...
	const processSteps = [
		{
			...
			description: "We define your core app features, user flows, and success goals to build a roadmap.",
			icon: Users,
		...
		},
		{
			...
			description: "Efficient development using Flutter or React Native to deploy across platforms.",
			icon: Code,
		...
		},
		{
			...
			description: "Real-device testing, Play Store/App Store compliance, and secure launch practices.",
			icon: Shield,
