	...
	const processSteps = [
		{
			...
			description: "We understand your goals, users, and desired functionality to create a clear roadmap.",
			icon: Users,
		...
		},
		{
			...
			description: "Clean, modern designs that prioritize usability, mobile responsiveness, and visual impact.",
			icon: Layout,
		...
		},
		{
			number: "03",
			title: "Development",
			description: "Pixel-perfect development using frameworks like React, Next.js, or others based on your need.",
			icon: Code,
			imagePath: "./images/process3.png"
		},
		{
			number: "04",
			title: "Testing & Secure Deployment",
			description: "Cross-browser, cross-device testing and We launch with HTTPS and essential security best practices.",
			icon: Shield,
